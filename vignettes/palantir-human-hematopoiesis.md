...
In the local run, the top 20 ranked genes were `S100A4`, `ATPIF1`, `NAA38`,
`TMEM14C`, `MYL6`, `TPI1`, `SERBP1`, `HNRNPA2B1`, `NDUFS5`, `CHCHD2`, `MT-ND1`,
`MT-CO3`, `TCEB2`, `PRDX2`, `UQCRQ`, `PRSS57`, `BLVRB`, `ATP5J2`, `NOP10`, and
`TMEM14B`. The first 12 genes had `PeakFAP` values reported as 0 because of
floating-point underflow, and ranks 13--20 had `PeakFAP` values from
`3.38e-312` to `9.66e-293`.
